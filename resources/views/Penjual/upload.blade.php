            ...
            <div class="container pb-5 mb-3">
                ...
                <div class="form row m-2">
                    <form class="row d-flex">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <li class="dropdown-item"><input type="checkbox" name="category[]"
                                            value="kategori1"> Kategori 1</li>
                                    <li class="dropdown-item"><input type="checkbox" name="category[]"
                                            value="kategori2"> Kategori 2</li>
                                    <li class="dropdown-item"><input type="checkbox" name="category[]"
                                            value="kategori3"> Kategori 3</li>
                                    <li class="dropdown-item"><input type="checkbox" name="category[]"
                                            value="kategori1"> Kategori 1</li>
                                    <li class="dropdown-item"><input type="checkbox" name="category[]"
                                            value="kategori2"> Kategori 2</li>
                        ...
                        <button type="submit" class="btn btn-primary mt-3 ms-5" style="width: 200px;"><i class='bx bxs-cloud-upload me-2'></i>Upload</button></div>
                    </form>
                </div>
        </section>
    </main>
