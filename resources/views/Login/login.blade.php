        ...
        <div class="forms">
            <div class="form-content row justify-content-around">
                <div class="lg-form col-md-5 col-lg-5">
                    <div class="logo top-0 d-flex pt-4 mb-5">
                        <img class="logo-img" src="{{ asset('images/logo1.png') }}" style="height: 40px;" alt="Logo">
                        <h2 class="logo-title pt-1"
                            style="font-family: 'Noto Serif', serif; font-size: 24px; margin-left: 10px;">NutriBites
                        </h2>
                    </div>
                    <div class="upper-text">
                    <h3 class="title pt-3 mb-0" >Selamat datang kembali!</h3>
                    ...
                    <form action="proses_login.php" method="post">
                        <div class="input-boxs">
                            ...
                            <div class="btn input-box d-block pt-5">
                ...
                <div class="reg-form col-lg-5 col-md-5">
                    <div class="logo top-0 d-flex pt-4 mb-5">
                        <img class="logo-img" src="{{ asset('images/logo1.png') }}" style="height: 40px;">
                        <h2 class="logo-title pt-1"
                            style="font-family: 'Noto Serif', serif; font-size: 24px; margin-left: 10px;">NutriBites
                        </h2>
                    </div>
